...
async function loginUser() {
    ...
    const response = await fetch("http://13.127.232.228:5001/login", {
...
async function loadMovies() {
    ...
    const response = await fetch("http:13.127.232.228:5002/movies");
...
async function bookMovie(movieName) {
    ...
    // Booking Request
    await fetch("http://13.127.232.228:5003/book", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
    ...
    // Payment Request
    const payment = await fetch("http://13.127.232.228:5004/pay", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
